...
export const AwardContent = {
  title: "Award and Certifications",
  content:
...
export const AwardImageContent = [
  {
    ...
    date: "10/28/2020",
    caption:
      "PT Ceria Nugraha Indotama (CNI) as the holder of the Mining Business Permit Area (WIUP), operating in Wolo sub-district, has received a blue report card in the company performance rating assessment program (Proper)...",
